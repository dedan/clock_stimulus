...
// $Revision: 1.1.6.4 $  $Date: 2004/12/01 19:50:39 $
...
HRESULT CadvantechAin::Open(IUnknown *Interface,long ID)
{
    ...
    // Geck 224997:  Error message for Advantech DAT object constructors
    // should be enhanced. If number of AI channels is 0, this subsystem
    // isn't supported.
    if(m_DevFeatures.usMaxAIDiffChl == 0 && m_DevFeatures.usMaxAISiglChl == 0)
