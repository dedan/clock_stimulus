...
// $Revision: 1.1.6.2 $  $Date: 2004/12/01 19:50:53 $
...
// Create a custom trace category for MCC UL calls
static CTraceCategory MCC_UL_CALL( "MCC Universal Library Calls", 3 );
