...
// $Revision: 1.1.6.3 $  $Date: 2004/07/30 01:56:18 $
...
public:
    ...
    int     _packetSize;        // If this value is not -1, the buffer size will be
                                // adjusted to a multiple of this value.  See geck 214725
