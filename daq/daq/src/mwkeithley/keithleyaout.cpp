...
STDMETHODIMP Ckeithleyaout::Stop()
{
	...
	if (m_daqStatus == STATUS_RUNNING)
	{
        ...
        // Check to see if there is no error or if the error returned
        // indicates that the service request has already been terminated
        // (ResultCode == 16439)
		if(ResultCode !=0 && ResultCode != 16439)
		{
