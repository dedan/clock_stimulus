...
// $Author: batserve $
// $Revision: 1.1.6.4 $  $Date: 2004/12/18 07:35:06 $
//////////////////////////////////////////////////////////////////////
...
HRESULT CParallelDriver::InitDriver()
{
    ...
    results = InitializeWinIoV2();

    // If initialization fails, return FAIL
    if (results != WINIO_SUCCESS)
    {
    ...
    case WINIO_SUCCESS:
	    return S_OK;
    case WINIO_ERR_GENERAL:
	    return E_FAIL; 
    case WINIO_ERR_COULD_NOT_START_WINIO_SYS:
	    return E_COULD_NOT_START_WINIO_SYS; 
    case WINIO_ERR_NO_WINIO_SYS:
	    return E_NO_WINIO_SYS; 
    case WINIO_ERR_COULD_NOT_COPY_WINIO_SYS:
	    return E_COULD_NOT_COPY_WINIO_SYS; 
    case WINIO_ERR_WINIO_SYS_DID_NOT_START:
	    return E_WINIO_SYS_DID_NOT_START;
    case WINIO_ERR_COULD_NOT_CONNECT_WINIO_SYS:
	    return E_COULD_NOT_CONNECT_WINIO_SYS;
	case WINIO_ERR_WINIO_SYS_IN_USE:
	    return E_WINIO_SYS_ALREADY_IN_USE;
    default:
        return E_FAIL;
    }
