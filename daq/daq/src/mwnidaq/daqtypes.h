...
// $Revision: 1.3.4.5 $  $Date: 2004/12/01 19:50:59 $
...
public:
    ...
    double CalculateClosestESeriesTimeBaseAndInterval(double RequestedSampleRate, short * ptimebase, unsigned short * psampleInterval);
