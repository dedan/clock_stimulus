...
%    $Revision: 1.12.2.6 $  $Date: 2004/12/01 19:46:54 $
...
try
   propstruct = propinfo(x.uddobject, prop);
catch
...
if any(findstr('changing the', errmsg)) || any(findstr('type mismatch', errmsg)) || ...
   ...
   if strcmp(propstruct.ReadOnly,'always')
      ...
      return;
   elseif strcmpi(propstruct.ReadOnly,'whileRunning') && strcmpi( get(parent, 'Running'), 'on')
